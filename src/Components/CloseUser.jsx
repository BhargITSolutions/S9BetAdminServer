...
function CloseUser() {
    ...
    const fetchUserData = async () => {
        setIsLoading(true);
        try {
            const fetched = await fetch('https://api.s2bet.in/closeUsers');
    ...
    const changeChildPassWord = async () => {
        ...
        try {
            ...
            if (result.isSuccess == true) {
                ...
                const close = document.getElementById('cngpwd');
                                                    ...
                                                    <tr key={item.id}>
                                                        ...
                                                        <td className="last">
                                                            <div className="">
                                                                ...
                                                                <Link className="btn btn-danger btn-xs" to='/statementByUser' state={{ userId: item.Id, roleId: item.RoleId, userName: item.UserName  }}><span>S</span></Link>{" "}
                                                                <Link to='/downlineProfitLoss' className="btn btn-primary btn-xs" state={{ userId: item.Id }}><span> PL</span></Link>{" "}
                                                                {/* <a

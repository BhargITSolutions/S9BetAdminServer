...
export const MatchSetting = () => {
    ...
    const fetchDataForMinAndMaxAmount = async (gameId, sportId) => {
        let res = await fetch(`https://api.s2bet.in/api/checkAndSendData/matchSettingPage/${gameId}/${sportId}`);
    ...
    const updateDataForMinAndMaxAmount = async () => {
        ...
        try {
            ...
            let res = await fetch(`https://api.s2bet.in/api/checkAndUpdateData/matchSettingPage/${gameId}/${minOdds}/${maxOdds}/${minBookmaker}/${maxBookmaker}/${minSession}/${maxSession}`, {
                method: 'PUT',
                headers: {
    ...
    const handleSearchFunc = async (e) => {
        ...
        try {
            ...
            let res = await fetch(`https://api.s2bet.in/api/getdataBySearch?q=${searchWord}`);
            let resData = await res.json();
            setData(resData);
        } catch (error) {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            let res = await fetch(`https://api.s2bet.in/api/getMatchEventData/${showActiveData}/${sportStatus}`);
            let resData = await res.json();
            //  console.log(resData);
            setData(resData);
        } catch (error) {
    ...
    const updateSportStatus = useCallback(async (event, id, whichToUpdate) => {
        ...
        Swal.fire({
            ...
            try {
                let res = await fetch(`https://api.s2bet.in/api/updateMatchSettingData/${id}/${status}/${whichToUpdate}`, {
                    method: 'PUT',
                    headers: {
                        'Content-Type': 'application/json',
                    }
